...
MENU_BTN_CATALOG = "🛍 Лента товаров"
MENU_BTN_ORDERS = "📋 Мои заявки"
ALL_MENU_BUTTONS = [MENU_BTN_CATALOG, MENU_BTN_ORDERS]
...
ORDER_DATA_ERROR = "Не удалось продолжить оформление: товар не найден или был удален."
