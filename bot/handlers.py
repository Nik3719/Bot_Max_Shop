...
# --- АДМИНКА ---
@router.message_created(Command("sync_from_sheets"))
@admin_only
...
@router.message_created(Command("sync_to_sheets"))
@admin_only
...
@router.message_created(Command("sync_status"))
@admin_only
...
@router.message_created(Command("orders"))
@admin_only
